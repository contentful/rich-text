...
with a new line.`),
        ...
        block(
          ...
          block(
            BLOCKS.TABLE_ROW,
            {},
            block(BLOCKS.TABLE_HEADER_CELL, {}, block(BLOCKS.PARAGRAPH, {}, text('Name'))),
            block(BLOCKS.TABLE_HEADER_CELL, {}, block(BLOCKS.PARAGRAPH, {}, text('Country'))),
          ),
          block(
            BLOCKS.TABLE_ROW,
            {},
        ...
        block(
          ...
          block(
            BLOCKS.TABLE_ROW,
            {},
            block(BLOCKS.TABLE_HEADER_CELL, {}, block(BLOCKS.PARAGRAPH, {}, text('abc'))),
            block(BLOCKS.TABLE_HEADER_CELL, {}, block(BLOCKS.PARAGRAPH, {}, text('def'))),
          ),
        ),
        ...
        block(
          ...
          block(
            BLOCKS.TABLE_ROW,
            {},
            block(BLOCKS.TABLE_HEADER_CELL, {}, block(BLOCKS.PARAGRAPH, {}, text(''))),
            block(BLOCKS.TABLE_HEADER_CELL, {}, block(BLOCKS.PARAGRAPH, {}, text(''))),
          ),
          block(
            BLOCKS.TABLE_ROW,
